...
See [Scribe Integrations — Slack Browser Monitoring](https://summon-claude.github.io/summon-claude/latest/guide/scribe-integrations/#slack-browser-monitoring) for full setup instructions.
...
For full setup instructions (install, authentication, channel selection), see [Scribe Integrations — Slack Browser Monitoring](https://summon-claude.github.io/summon-claude/latest/guide/scribe-integrations/#slack-browser-monitoring).
...
The canvas is updated after each scan cycle. See [Canvas Integration](https://summon-claude.github.io/summon-claude/latest/guide/canvas/index.md) for how the canvas sync works.
...
- [Projects](https://summon-claude.github.io/summon-claude/latest/guide/projects/index.md) — the project system the scribe runs within
