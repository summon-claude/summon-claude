...
The PM can update the canvas at any time using the `summon_canvas_update_section` MCP tool. See [Canvas Integration](https://summon-claude.github.io/summon-claude/latest/guide/canvas/index.md) for details.
...
For full details on cron expressions, task tool parameters, and canvas integration, see [Cron & Tasks](https://summon-claude.github.io/summon-claude/latest/guide/cron-tasks/index.md).

______________________________________________________________________

## See also

- [Projects](https://summon-claude.github.io/summon-claude/latest/guide/projects/index.md) — setting up and managing projects
- [Canvas](https://summon-claude.github.io/summon-claude/latest/guide/canvas/index.md) — persistent markdown in Slack channel tabs
- [Cron & Tasks](https://summon-claude.github.io/summon-claude/latest/guide/cron-tasks/index.md) — scheduled jobs and task tracking
