...
This guide assumes you've completed the [Quick Start](https://summon-claude.github.io/summon-claude/latest/getting-started/quickstart/index.md) and have a working `summon config check`.
...
The specific tools available depend on the Rovo MCP server version. All 31 currently known tools are classified into [permission tiers](https://summon-claude.github.io/summon-claude/latest/reference/permissions/#jira-mcp-permissions).
...
For the full tool-by-tool breakdown, see the [Permissions reference](https://summon-claude.github.io/summon-claude/latest/reference/permissions/#jira-mcp-permissions).

______________________________________________________________________

## PM agent integration

When [PM agents](https://summon-claude.github.io/summon-claude/latest/guide/pm-agents/index.md) are configured with Jira, they automatically triage Jira issues during each periodic scan cycle.
...
1. Assesses urgency based on priority, due date, and labels.
1. For high/critical issues: posts a summary to the PM's Slack channel and optionally notifies relevant child sessions via `session_message`.
1. Updates the canvas under a "Jira Issues" section to track triaged issues.
1. For normal-priority issues: updates the canvas only (no Slack notification).
...
Scribe sessions are wired to the Jira MCP server with Jira-aware system prompts (untrusted-content warnings, Gmail/Jira dedup) and scan prompts (mentions, assignments, status changes via JQL).

When both Google Workspace and Jira are active, the scribe system prompt instructs Gmail deduplication — Jira notification emails (from `jira@` or `noreply@` at `atlassian.net` domains) are skipped since they're covered by direct Jira monitoring.

______________________________________________________________________

## Troubleshooting

See the [Jira troubleshooting section](https://summon-claude.github.io/summon-claude/latest/troubleshooting/#jira) for common issues and solutions.

______________________________________________________________________

## See also

- [GitHub Integration](https://summon-claude.github.io/summon-claude/latest/guide/github-integration/index.md) — GitHub remote MCP setup and permissions
- [Scribe Integrations](https://summon-claude.github.io/summon-claude/latest/guide/scribe-integrations/index.md) — Google Workspace and Slack browser monitoring
- [Projects](https://summon-claude.github.io/summon-claude/latest/guide/projects/index.md) — project registration and JQL filters
- [PM Agents](https://summon-claude.github.io/summon-claude/latest/guide/pm-agents/index.md) — autonomous project management
- [Permissions](https://summon-claude.github.io/summon-claude/latest/reference/permissions/#jira-mcp-permissions) — full permission evaluation flow
