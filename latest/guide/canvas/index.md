...
- [PM Agents](https://summon-claude.github.io/summon-claude/latest/guide/pm-agents/index.md) — how the PM uses the canvas for work tracking
- [Scribe](https://summon-claude.github.io/summon-claude/latest/guide/scribe/index.md) — the scribe canvas structure
