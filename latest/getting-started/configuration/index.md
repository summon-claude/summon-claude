...
1. **App Token** -- the `xapp-` token from Basic Information > App-Level Tokens
1. **Signing Secret** -- the hex string from Basic Information > App Credentials
...
[Quick Start](https://summon-claude.github.io/summon-claude/latest/getting-started/quickstart/index.md)
