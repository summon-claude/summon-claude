...
| Parameter     | Type   | Required | Default | Description                                                     |
| ------------- | ------ | -------- | ------- | --------------------------------------------------------------- |
| `status`      | string | No       | *(all)* | Filter by status: `pending`, `in_progress`, or `completed`      |
...
| `model`          | string | No       | *(inherited)*         | Model override                                                                                                                            |
...
See [Canvas](https://summon-claude.github.io/summon-claude/latest/guide/canvas/index.md) for details on how the canvas is structured and synced to Slack.
