...
These three options must be set before summon can start. See [Slack Setup](https://summon-claude.github.io/summon-claude/latest/getting-started/slack-setup/index.md) for instructions on obtaining these values.
...
See [Sessions](https://summon-claude.github.io/summon-claude/latest/guide/sessions/index.md) for how model and effort affect behavior.

______________________________________________________________________

## Scribe

Core settings for the background scribe agent. See [Scribe](https://summon-claude.github.io/summon-claude/latest/guide/scribe/index.md) for full setup and configuration details.
...
See [Permissions](https://summon-claude.github.io/summon-claude/latest/reference/permissions/#auto-mode-classifier) for the full classification flow and default rules.
