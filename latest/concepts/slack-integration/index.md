...
Every output method calls `redact_secrets()` before sending to Slack. See [Security](https://summon-claude.github.io/summon-claude/latest/concepts/security/index.md) for the redaction pattern.
