...
- [Sessions](https://summon-claude.github.io/summon-claude/latest/guide/sessions/index.md) — session lifecycle and management
- [Cron & Tasks](https://summon-claude.github.io/summon-claude/latest/guide/cron-tasks/index.md) — scheduled jobs and task tracking
- [Canvas](https://summon-claude.github.io/summon-claude/latest/guide/canvas/index.md) — persistent session documents that survive compaction
