...
- **Jira scribe scaffolding** — Forward-compatible Jira monitoring in scribe system prompt with Gmail dedup (skips Jira notification emails when both sources are active). Not yet wired to production scribe sessions (#94)
