...
- **Jira scribe integration** — Jira MCP wired to scribe sessions with domain-specific system prompt (untrusted-content warnings, Gmail/Jira dedup when both sources are active). Scribe scan prompt does not yet include Jira-specific scan instructions (#94)
