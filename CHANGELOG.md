...
- **Jira scribe integration** — Jira MCP wired to scribe sessions with domain-specific system prompt (untrusted-content warnings). Scribe scan prompt does not yet include Jira-specific scan instructions or Gmail/Jira dedup (#94)
