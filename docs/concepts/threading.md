...
| Reaction | Meaning |
|----------|---------|
| :inbox_tray: | Message received, preprocessing in progress |
| :gear: | Turn in progress (Claude is working) |
...
!!! note "Ultrathink reaction"
    If your message contains a thinking trigger (`ultrathink`, `think harder`, etc.), a :brain: reaction is also added permanently to your message.
...
- With `SUMMON_SHOW_THINKING=true`: thinking content is posted to the turn thread as a collapsible context block with a :thought_balloon: prefix.
