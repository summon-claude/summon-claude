...
2. Identifies what was being worked on
3. Notes decisions, file changes, and errors
4. Confirms with the user what was recovered before proceeding
...
- [Sessions](../guide/sessions.md) — session lifecycle and management
- [Cron & Tasks](../guide/cron-tasks.md) — scheduled jobs and task tracking
- [Canvas](../guide/canvas.md) — persistent session documents that survive compaction
