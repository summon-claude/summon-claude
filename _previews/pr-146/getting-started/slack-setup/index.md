...
With your credentials collected, proceed to the [Configuration](https://summon-claude.github.io/summon-claude/getting-started/configuration/index.md) page to run the setup wizard and verify your installation.
