...
The specific tools available depend on the Rovo MCP server version. All 31 currently known tools are classified into [permission tiers](https://summon-claude.github.io/summon-claude/reference/permissions/#jira-mcp-permissions).
...
For the full tool-by-tool breakdown, see the [Permissions reference](https://summon-claude.github.io/summon-claude/reference/permissions/#jira-mcp-permissions).

______________________________________________________________________

## PM agent integration

When [PM agents](https://summon-claude.github.io/summon-claude/guide/pm-agents/index.md) are configured with Jira, they automatically triage Jira issues during each periodic scan cycle.
...
See the [Jira troubleshooting section](https://summon-claude.github.io/summon-claude/troubleshooting/#jira) for common issues and solutions.

______________________________________________________________________

## See also

- [GitHub Integration](https://summon-claude.github.io/summon-claude/guide/github-integration/index.md) — GitHub remote MCP setup and permissions
- [Scribe Integrations](https://summon-claude.github.io/summon-claude/guide/scribe-integrations/index.md) — Google Workspace and Slack browser monitoring
- [Projects](https://summon-claude.github.io/summon-claude/guide/projects/index.md) — project registration and JQL filters
- [PM Agents](https://summon-claude.github.io/summon-claude/guide/pm-agents/index.md) — autonomous project management
- [Permissions](https://summon-claude.github.io/summon-claude/reference/permissions/#jira-mcp-permissions) — full permission evaluation flow
