...
- summon-claude [installed](https://summon-claude.github.io/summon-claude/getting-started/installation/index.md)
- [Slack app configured](https://summon-claude.github.io/summon-claude/getting-started/slack-setup/index.md) and [configuration verified](https://summon-claude.github.io/summon-claude/getting-started/configuration/index.md) (`summon config check` passing)
...
This creates a named project that summon-claude tracks. You can optionally set [workflow instructions](https://summon-claude.github.io/summon-claude/guide/projects/#managing-workflow-instructions) that guide every session:
...
For full details on emoji reactions and thread organization, see [Threading](https://summon-claude.github.io/summon-claude/concepts/threading/index.md).
...
Click **Approve** to let Claude proceed, or **Deny** to reject the action. Claude adapts its approach based on your decision. Read-only tools (file reads, searches, web fetches) are auto-approved without prompting — see [Permissions](https://summon-claude.github.io/summon-claude/reference/permissions/index.md) for the full list.
...
See [Sessions](https://summon-claude.github.io/summon-claude/guide/sessions/index.md) for details.

______________________________________________________________________

## See also

- [Projects](https://summon-claude.github.io/summon-claude/guide/projects/index.md) — multi-session project management with PM agents
- [Sessions](https://summon-claude.github.io/summon-claude/guide/sessions/index.md) — session lifecycle, naming, and management
- [Commands](https://summon-claude.github.io/summon-claude/reference/commands/index.md) — full command reference for in-channel interaction
- [Permissions](https://summon-claude.github.io/summon-claude/reference/permissions/index.md) — how tool permission handling works
- [Configuration](https://summon-claude.github.io/summon-claude/guide/configuration/index.md) — customize summon-claude behavior
