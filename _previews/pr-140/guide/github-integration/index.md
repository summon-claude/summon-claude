...
If your project has [workflow instructions](https://summon-claude.github.io/summon-claude/guide/projects/#managing-workflow-instructions) that define pre-review steps (e.g., "run the test suite before review"), the PM follows those steps first and only spawns a reviewer after they pass.
...
- [PM Agents](https://summon-claude.github.io/summon-claude/guide/pm-agents/index.md) — spawning reviewer sessions
- [Sessions](https://summon-claude.github.io/summon-claude/guide/sessions/index.md) — session lifecycle
