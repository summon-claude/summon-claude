...
Breaking changes are documented in the [changelog](https://summon-claude.github.io/summon-claude/changelog/index.md) and on the [GitHub releases](https://github.com/summon-claude/summon-claude/releases) page with migration instructions.
