...
This guide assumes you've completed the [Quick Start](https://summon-claude.github.io/summon-claude/getting-started/quickstart/index.md) and [set up a project](https://summon-claude.github.io/summon-claude/guide/projects/index.md).
...
1. PM posts the code to its own channel (or directs you)
1. You (or the PM directing you) type `/summon CODE` in the target channel
1. The child binds to that channel and begins working
...
The PM can update the canvas at any time using the `summon_canvas_update_section` MCP tool. See [Canvas Integration](https://summon-claude.github.io/summon-claude/guide/canvas/index.md) for details.
...
1. Identify completed, stuck, or failed sessions
1. Take corrective actions (stop, restart, or report to you)
1. Update the project canvas with current task status
...
For full details on cron expressions, task tool parameters, and canvas integration, see [Cron & Tasks](https://summon-claude.github.io/summon-claude/guide/cron-tasks/index.md).

______________________________________________________________________

## See also

- [Projects](https://summon-claude.github.io/summon-claude/guide/projects/index.md) — setting up and managing projects
- [Canvas](https://summon-claude.github.io/summon-claude/guide/canvas/index.md) — persistent markdown in Slack channel tabs
