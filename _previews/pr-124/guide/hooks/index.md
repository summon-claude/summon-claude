...
- [Projects](https://summon-claude.github.io/summon-claude/guide/projects/index.md) — project registration and management
- [Configuration](https://summon-claude.github.io/summon-claude/guide/configuration/index.md) — config file location and management
- [CLI Reference](https://summon-claude.github.io/summon-claude/reference/cli/index.md) — full `summon hooks` command reference
