...
**Fix:** Go to **api.slack.com/apps → Your App → OAuth & Permissions → Scopes** and add the required bot token scopes. After adding scopes, reinstall the app to your workspace. See [Slack Setup](https://summon-claude.github.io/summon-claude/getting-started/slack-setup/index.md) for the full scope list.
...
**Behavior:** This is by design. See [Permissions](https://summon-claude.github.io/summon-claude/reference/permissions/index.md) for details.
