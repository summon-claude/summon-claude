...
- [PM Agents](https://summon-claude.github.io/summon-claude/guide/pm-agents/index.md) — how the PM coordinates tasks across sessions
- [Canvas](https://summon-claude.github.io/summon-claude/guide/canvas/index.md) — how cron and task data appears on the canvas
- [Configuration](https://summon-claude.github.io/summon-claude/guide/configuration/index.md) — session-level configuration options
