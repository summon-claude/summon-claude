...
1. Builds a Markdown report with full details
1. Shows you the redacted report for review
1. Asks for confirmation before submitting
1. Creates an issue on the summon-claude repository
