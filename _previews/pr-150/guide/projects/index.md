...
To associate a [Jira JQL filter](https://summon-claude.github.io/summon-claude/guide/jira-integration/#per-project-jql-filters) with the project:
...
- [Jira Integration](https://summon-claude.github.io/summon-claude/guide/jira-integration/index.md) — JQL filters and PM triage
- [Scribe](https://summon-claude.github.io/summon-claude/guide/scribe/index.md) — background monitoring agent
- [Configuration](https://summon-claude.github.io/summon-claude/guide/configuration/index.md) — project-level config options
